...
// 参考
// https://gentome.com/gentomeblog/1600/flickermodel/
public class FlickerModel : MonoBehaviour
{
    ...
    public void Flicker()
    {
    	...
    	StartCoroutine(MyFlicker(
            _materialAndInitialColors, flickerColor, flickerSpeed, flickerDuration, this.gameObject));
    }
    ...
    IEnumerator MyFlicker(Dictionary<Material,Color> matAndInitialColors/*マテリアルと初期設定してあるカラー*/,
